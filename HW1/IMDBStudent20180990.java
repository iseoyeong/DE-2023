...
public class IMDBStudent20180990 {
	...
	public static class GenreCountMapper extends Mapper<Object, Text, Text, IntWritable>
	{
    		private final static IntWritable one = new IntWritable(1);
    		private Text word = new Text();

    		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			String genre = value.toString().split("::")[2];
	...
	public static class GenreCountReducer extends Reducer<Text,IntWritable,Text,IntWritable>
    	...
    	public static void main(String[] args) throws Exception
    	{
            	...
            	{
                    	System.err.println("Usage: genrecount <in> <out>");
                    	System.exit(2);
            	}
